  ...
  const articles = [
    {
      ...
      content:
        '選擇適合的寵物食品是照顧毛孩健康的第一步。首先應根據毛孩的年齡、體型與活動量來挑選合適的飼料。幼犬、成犬與老犬的營養需求不同，錯誤的選擇可能導致營養不均或消化不良。體型較小的犬貓可能需要更小顆粒的飼料，而大型犬則需要含有關節保護成分的配方。市面上常見的乾糧與罐頭各有優缺點，乾糧方便保存，並有助於牙齒清潔，但水分含量低；罐頭則富含水分，對不愛喝水的毛孩是個不錯的選擇。建議可根據需求混合餵食。此外，也別忽略查看成分標示，選擇有標明肉類來源、無過多副產品與人工添加物的品牌更為理想。若毛孩有特殊需求，如過敏或腸胃敏感，則應尋求獸醫建議，挑選專業處方食品。記得，適當的飲食不僅讓毛孩健康，也能延長牠們的壽命與生活品質。',
      created_at: faker.date.recent({ days: 90 }).toISOString()
    },
    {
      title: '寵物玩具的重要性',
